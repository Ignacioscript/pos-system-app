            ...
            <x-slot:table>
                <table class="min-w-full leading-normal table-auto">
                    ...
                    <tr>
                        ...
                        <th class="px-5 py-3 border-b-2 text-left text-xs font-semibold dark:text-gray-100 uppercase tracking-wider">Cantidad</th>
                        <th class="px-5 py-3 border-b-2 text-left text-xs font-semibold dark:text-gray-100 uppercase tracking-wider">Precio</th>
                        <th class="px-5 py-3 border-b-2 text-left text-xs font-semibold dark:text-gray-100 uppercase tracking-wider">Descuento</th>
                        <th class="px-5 py-3 border-b-2 text-left text-xs font-semibold dark:text-gray-100 uppercase tracking-wider">Total</th>
...
{{--                        <th class="px-5 py-3 border-b-2 text-left text-xs font-semibold dark:text-gray-100 uppercase tracking-wider"></th>--}}
                    ...
                    @foreach($sales as $sale)
                        <tr>
                            <td class="px-5 py-5 dark:text-gray-100 text-sm">{{ $sale->id }}</td>
                            ...
                            <td class="px-5 py-5 dark:text-gray-100 text-sm">{{ $sale->quantity }}</td>
                            <td class="px-5 py-5 dark:text-gray-100 text-sm">{{ $sale->price }}</td>
                            <td class="px-5 py-5 dark:text-gray-100 text-sm">{{ $sale->discount }}</td>
                            <td class="px-5 py-5 dark:text-gray-100 text-sm">{{ $sale->total }}</td>
