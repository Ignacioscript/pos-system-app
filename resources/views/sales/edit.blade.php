...
<x-app-layout>
    <x-header>Editar Venta</x-header>
...
<div class="space-y-12 items-center">
    <div class="border-b border-gray-900/10 pb-12">
        <div class="border-b border-gray-900/10 pb-12">
            ...
            <p class="mt-1 text-sm/6 text-gray-600 dark:text-gray-300" >Edita los campos de la venta.</p>
                    ...
                    <div class="mt-2 grid grid-cols-1">
                        <select
                            ...
                            @foreach($products as $product)
                                <option value="{{ $product->id }}" {{$product->id == $sale->product_id ? 'selected' : ''}}> {{ $product->product_name }}
                                </option>
                            @endforeach
                    ...
                    <div class="mt-2 grid grid-cols-1">
                        <select
                            ...
                            @foreach($customers as $customer)
                                <option value="{{ $customer->id }}" {{$customer->id == $sale->customer_id ? 'selected' : ''}}> {{ $customer->first_name }} {{$customer->last_name}}</option>
                            @endforeach
