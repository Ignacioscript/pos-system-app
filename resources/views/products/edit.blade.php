<x-app-layout>
    <x-header> Edit: {{ $product->product_name }}</x-header>
            ...
            <form method="POST" action="{{ route('products.update', $product->id) }}">
                ...
                <div class="space-y-12 items-center">
                    <div class="border-b border-gray-900/10 pb-12">
                        <div class="border-b border-gray-900/10 pb-12">
                            <h2 class="text-base/7 font-semibold text-gray-900 dark:text-gray-100">Edit Product Information</h2>
                            <p class="mt-1 text-sm/6 text-gray-600 dark:text-gray-300" >Fill the fields with product's details.</p>

                            <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                <div class="sm:col-span-3">
                                    <label for="product_name" class="block text-sm/6 font-medium text-gray-900 dark:text-gray-100">Update Product Name</label>
                                    <div class="mt-2">
                                        <input
                                            type="text"
                                ...
                                <div class="sm:col-span-3">
                                    <label for="suppliers_ids" class="block text-sm/6 font-medium text-gray-900 dark:text-gray-100">Update Product Suppliers</label>
                                    <div class="mt-2">
                                        <select
                                            id="suppliers_ids"
                                            name="suppliers_ids[]"
                                ...
                                <div class="sm:col-span-2 sm:col-start-1">
                                    <label for="qty_stock" class="block text-sm/6 font-medium text-gray-900 dark:text-gray-100">Update Stock</label>
                                    <div class="mt-2">
                                        <input
                                            type="text"
                                            name="qty_stock"
                                            ...
                                            class="block w-full rounded-md dark:bg-gray-200px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6">
                                    </div>
                                    <x-forms.error name="qty_stock"></x-forms.error>
                                </div>

                                <div class="sm:col-span-2">
                                    <label for="price" class="block text-sm/6 font-medium text-gray-900 dark:text-gray-100">Update Price</label>
                                    <div class="mt-2">
                                        <input
                                            type="text"
                                            name="price"
                                ...
                                <!-- Category Field -->
                                <div class="sm:col-span-3">
                                    <label for="category" class="block text-sm/6 font-medium text-gray-900 dark:text-gray-100">Update Category</label>
                        ...
                        <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            ...
                            <div class="col-span-full">
                                <label for="description" class="block text-sm/6 font-medium text-gray-900 dark:text-gray-100">Update  Product Description</label>
                                <div class="mt-2">
                                    <textarea
                                        name="description"
                                        id="description"
                                ...
                                <p class="mt-3 text-sm/6 text-gray-600 dark:text-gray-300">Describe the product.</p>
                ...
                <div class="mt-6 flex items-center justify-end gap-x-6">
                    <a href="{{ route('products.index') }}" type="button" class="text-sm/6 font-semibold dark:text-gray-100 text-gray-900">Cancel</a>
