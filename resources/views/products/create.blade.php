<x-app-layout>
    <x-header> Create New Product</x-header>
           ...
           <form method="POST" action="{{ route('products.store') }}">
               ...
               <div class="space-y-12 items-center">
                   <div class="border-b border-gray-900/10 pb-12">
                       <div class="border-b border-gray-900/10 pb-12">
                           <h2 class="text-base/7 font-semibold text-gray-900 dark:text-gray-100">Product Information</h2>
                           <p class="mt-1 text-sm/6 text-gray-600 dark:text-gray-300" >Fill the fields with product's details.</p>

                           <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                               <div class="sm:col-span-3">
                                   <label for="product_name" class="block text-sm/6 font-medium text-gray-900 dark:text-gray-100">Product Name</label>
                                   <div class="mt-2">
                                       <input
                                           type="text"
                               ...
                               <div class="sm:col-span-3">
                                   <label for="suppliers_ids" class="block text-sm/6 font-medium text-gray-900 dark:text-gray-100">Product Suppliers</label>
                                   <div class="mt-2">
                                       <select
                                           id="suppliers_ids"
                                           name="suppliers_ids[]"
...
{{--                                           <option value="3">Compunets</option>--}}
                               ...
                               <div class="sm:col-span-2 sm:col-start-1">
                                   <label for="qty_stock" class="block text-sm/6 font-medium text-gray-900 dark:text-gray-100">Stock</label>
                                   <div class="mt-2">
                                       <input
                                           type="text"
                                           name="qty_stock"
                               ...
                               <div class="sm:col-span-2">
                                   <label for="price" class="block text-sm/6 font-medium text-gray-900 dark:text-gray-100">Price</label>
                                   <div class="mt-2">
                                       <input
                                           type="text"
                                           name="price"
...
{{--                               </div>--}}
                       ...
                       <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                           ...
                           <div class="col-span-full">
                               <label for="description" class="block text-sm/6 font-medium text-gray-900 dark:text-gray-100">Product Description</label>
                               <div class="mt-2">
                                    <textarea
                                        name="description"
                                        id="description"
...
{{--                           </div>--}}
               ...
               <div class="mt-6 flex items-center justify-end gap-x-6">
                   <a href="{{ route('products.index') }}" type="button" class="text-sm/6 font-semibold text-gray-900">Cancel</a>
