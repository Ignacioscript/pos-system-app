<x-app-layout>
    <x-header> Agrega Nuevo Producto</x-header>
           ...
           <form method="POST" action="{{ route('products.store') }}">
               ...
               <div class="space-y-12 items-center">
                   <div class="border-b border-gray-900/10 pb-12">
                       <div class="border-b border-gray-900/10 pb-12">
                           <h2 class="text-base/7 font-semibold text-gray-900 dark:text-gray-100">Informacion de Producto</h2>
                           <p class="mt-1 text-sm/6 text-gray-600 dark:text-gray-300" >Llena los campos con los detalles del nuevo producto.</p>

                           <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                               <div class="sm:col-span-3">
                                   <label for="product_name" class="block text-sm/6 font-medium text-gray-900 dark:text-gray-100">Producto</label>
                                   <div class="mt-2">
                                       <input
                                           type="text"
                               ...
                               <div class="sm:col-span-3">
                                   <label for="suppliers_ids" class="block text-sm/6 font-medium text-gray-900 dark:text-gray-100">Proveedor</label>
                                   <div class="mt-2">
                                       <select
                                           id="suppliers_ids"
                                           name="suppliers_ids[]"
