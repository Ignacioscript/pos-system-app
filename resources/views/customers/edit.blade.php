<x-app-layout>
    <x-header> Editar Cliente</x-header>
            ...
            <form method="POST" action="{{ route('customers.update', $customer->id) }}">
                ...
                <div class="space-y-12 items-center">
                    <div class="border-b border-gray-900/10 pb-12">
                        <div class="border-b border-gray-900/10 pb-12">
                            <h2 class="text-base/7 font-semibold text-gray-900 dark:text-gray-100"> Editar Informacion de Cliente</h2>
                            <p class="mt-1 text-sm/6 text-gray-600 dark:text-gray-300" >Edita los campos del cliente.</p>
