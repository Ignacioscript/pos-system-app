<x-app-layout>
    <x-header> Agrega Nuevo Proveedor</x-header>
                ...
                <div class="space-y-12 items-center">
                    <div class="border-b border-gray-900/10 pb-12">
                        <div class="border-b border-gray-900/10 pb-12">
                            ...
                            <p class="mt-1 text-sm/6 text-gray-600 dark:text-gray-300" >Llena los campos con los detalles del neuvo proveedor.</p>
                            ...
                            <div class="sm:col-span-3">
                                ...
                                <!-- New Location Field -->
                                <div class="mt-3">
                                    <a href="{{route('locations.create')}}"> Crear nueva Locacion</a> <!--TODO crear ruta para location y crud-->
                                </div>
                            </div>
