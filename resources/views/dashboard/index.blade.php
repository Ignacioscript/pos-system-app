...
{{--        <x-cards.card>--}}
{{--            <x-slot:title> Titutlo </x-slot:title>--}}
{{--            <x-slot:subtitle> Subtitulo </x-slot:subtitle>--}}
{{--            <x-slot:comment> comentario </x-slot:comment>--}}
{{--        </x-cards.card>--}}
{{--        <x-cards.card>--}}
{{--            <x-slot:title> Titutlo </x-slot:title>--}}
{{--            <x-slot:subtitle> Subtitulo </x-slot:subtitle>--}}
...
{{--                <!-- Recent Activities -->--}}
{{--                <div class="relative flex flex-col min-w-0 break-words bg-gray-50 dark:bg-gray-800 w-full shadow-lg rounded-xl">--}}
...
{{--                <!-- Task Summaries -->--}}
{{--                <div class=" grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 p-4 gap-4 text-black dark:text-white rounded-xl">--}}
{{--                    <div class="md:col-span-2 xl:col-span-3 ">--}}
{{--                        <h3 class="text-lg font-semibold">Task summaries of recent sprints</h3>--}}
{{--                    </div>--}}
{{--                    <div class="md:col-span-2 xl:col-span-1 min-full">--}}
{{--                        <div class="rounded-xl bg-gray-200 dark:bg-gray-800 p-3">--}}
...
{{--                                <div class="bg-white dark:bg-gray-600 hover:bg-gray-50 dark:hover:bg-gray-700 p-2 rounded mt-1 border-b border-gray-100 dark:border-gray-900 cursor-pointer">Delete all references from the wiki</div>--}}
{{--                                <div class="bg-white dark:bg-gray-600 hover:bg-gray-50 dark:hover:bg-gray-700 p-2 rounded mt-1 border-b border-gray-100 dark:border-gray-900 cursor-pointer">Remove analytics code</div>--}}
{{--                                <div class="bg-white dark:bg-gray-600 hover:bg-gray-50 dark:hover:bg-gray-700 p-2 rounded mt-1 border-b border-gray-100 dark:border-gray-900 cursor-pointer">Do a mobile first layouts</div>--}}
{{--                                <div class="bg-white dark:bg-gray-600 hover:bg-gray-50 dark:hover:bg-gray-700 p-2 rounded mt-1 border-b border-gray-100 dark:border-gray-900 cursor-pointer">Check the meta tags</div>--}}
{{--                                <div class="bg-white dark:bg-gray-600 hover:bg-gray-50 dark:hover:bg-gray-700 p-2 rounded mt-1 border-b border-gray-100 dark:border-gray-900 cursor-pointer">--}}
{{--                                    Think more tasks for this example--}}
{{--                                    <div class="text-gray-500 dark:text-gray-200 mt-2 ml-2 flex justify-between items-start">--}}
...
{{--                <!-- Client Table -->--}}
{{--                <div class="mt-4 mx-4">--}}
{{--                    <div class="w-full overflow-hidden rounded-xl shadow-xs">--}}
...
{{--                        <div class="p-6 mr-2 bg-gray-100 dark:bg-gray-800 sm:rounded-xl">--}}
...
{{--                <!-- ./Contact Form -->--}}
                ...
                <!-- External resources -->
                <div class="mt-8 mx-4">
                    <div class="p-4 bg-blue-50 dark:bg-gray-800 dark:text-gray-50 border border-blue-500 dark:border-gray-500 rounded-xl shadow-md">
                        <h4 class="text-lg font-semibold">Bienvenido a su Sistema de Venta, aqui puede acceder rapidamente a los siguientes espacios:</h4>
                        <ul>
                            <li class="mt-3">
                                <a class="flex items-center text-blue-700 dark:text-gray-100" href="{{route('sales.create')}}" target="_blank">
                                    ...
                                    <span class="inline-flex pl-2">Crear Nueva Venta</span>
                                </a>
                            </li>
                            <li class="mt-2">
                                <a class="flex items-center text-blue-700 dark:text-gray-100" href="{{route('products.create')}}" target="_blank">
                                    <svg width="20" height="20" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="transform transition-transform duration-500 ease-in-out"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 9l3 3m0 0l-3 3m3-3H8m13 0a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                                    <span class="inline-flex pl-2">Crear Nuevo Producto</span>
                                </a>
                            </li>
                            <li class="mt-2">
                                <a class="flex items-center text-blue-700 dark:text-gray-100" href="{{route('customers.create')}}" target="_blank">
                                    <svg width="20" height="20" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="transform transition-transform duration-500 ease-in-out"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 9l3 3m0 0l-3 3m3-3H8m13 0a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                                    <span class="inline-flex pl-2">Crear Nuevo Cliente</span>
                                </a>
                            </li>
                            <li class="mt-2">
                                <a class="flex items-center text-blue-700 dark:text-gray-100" href="{{route('suppliers.create')}}" target="_blank">
                                    <svg width="20" height="20" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="transform transition-transform duration-500 ease-in-out"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 9l3 3m0 0l-3 3m3-3H8m13 0a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                                    <span class="inline-flex pl-2">Crear Nuevo Proveedor</span>
                                </a>
                            </li>

                            <li class="mt-2">
                                <a class="flex items-center text-blue-700 dark:text-gray-100" href="{{route('categories.create')}}" target="_blank">
                                    <svg width="20" height="20" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="transform transition-transform duration-500 ease-in-out"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 9l3 3m0 0l-3 3m3-3H8m13 0a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                                    <span class="inline-flex pl-2">Crear Nueva Categoria</span>
                                </a>
                            </li>
                            <li class="mt-2">
                                <a class="flex items-center text-blue-700 dark:text-gray-100" href="{{route('locations.create')}}" target="_blank">
                                    <svg width="20" height="20" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="transform transition-transform duration-500 ease-in-out"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 9l3 3m0 0l-3 3m3-3H8m13 0a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                                    <span class="inline-flex pl-2">Crear Nueva Locacion</span>
                                </a>
                            </li>
                        </ul>
                    </div>
